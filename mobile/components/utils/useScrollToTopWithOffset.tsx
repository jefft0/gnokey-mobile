...
type ScrollableWrapper = { getScrollResponder(): React.ReactNode | ScrollView } | { getNode(): ScrollableView } | ScrollableView
...
export default function useScrollToTop(ref: React.RefObject<ScrollableWrapper>, offset: number = 0) {
